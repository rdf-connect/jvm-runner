...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StreamObserver<RunnerMessage> responseObserver = new StreamObserver<RunnerMessage>() {
            @Override
        ...
        StreamObserver<OrchestratorMessage> requestObserver = stub.connect(responseObserver);
        ...
        var msgBuilder = OrchestratorMessage.newBuilder().setStreamMsg(streamMessage).build();
